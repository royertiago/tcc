...
\begin{proof}
    ...
    Escolha $M$ como sendo uma máquina que computa $d$.
    Como $d$ pode ser computada em tempo polinomial,
    existe algum polinômio $p$ que limita o tempo de computação de $M$.
    Então escolha $n = p(k)$ caso a fórmula de entrada possua $k$ variáveis,
    e passe a fórmula $\varphi$ intocada para $\FdSAT$.
