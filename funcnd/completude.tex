...
\begin{proof}
    ...
    Reduza da função $f$ do teorema~\ref{thm:halt_fnp}.
    ...
    Agora, mostraremos que $\FdSAT(h(y)) = f(y)$,
    ...
    Ou seja, o máximo deste conjunto é $f(y)$,
    concluindo que $\FdSAT(h(y)) = f(y)$.

    Portanto, reduzimos $f$ a $\FdSAT$ e,
    portanto,
