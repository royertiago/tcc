...
\begin{example}
    ...
    Claramente o axioma~\ref{blum_def} é satisfeito.
...
Voltaremos a este problema no capítulo~\ref{funcoes_nao_deterministicas}.
Por ora,
...
\begin{proof}
    ...
    Pelo teorema da recursão (lema~\ref{teorema_recursao}),
