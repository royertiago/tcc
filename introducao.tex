...
e completar o capítulo~\ref{ch:hierarchy}.
...
Além disso, também preciso estender o capítulo~\ref{ch:hierarchy},
sobre hierarquias de classes computacionais.
Em particular,
terminar a seção~\ref{sec:constructible_functions},
sobre funções construtíveis
(que também possuem múltiplas definições incompatíveis na literatura)
e escrever as seções~\ref{sec:hierarchy_theorems},
sobre os teoremas da hierarquia,
e~\ref{sec:translation_lemma},
