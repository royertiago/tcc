...
\label{sec:constructible_functions}

Em alguns teoremas
(como, por exemplo,~\ref{thm:resource_waste} e~\ref{thm:outside_class})
...
para \citeonline[p.~297]{HopcroftUllman1979},
...
Por exemplo,
podemos estender a demonstração da proposição~\ref{thm:sublinear_time_regular}
